...
- fonte_visual: não
- Fontes usadas: Neuro_COMA__3d9a975464 (Edine Medeiros, NATIVA); APOSTILA_SA_II_P7___e43cc7bc21 (p.84-86)
- Evidência de prova/devolutiva: sem evidência específica mapeada no cluster para este tema; entrou na lista por prioridade/risco altos atribuídos pelo cluster.
...
Coma = incapacidade de obedecer a comandos, falar ou abrir os olhos mesmo com estímulo doloroso — comprometimento grave do sistema reticular ativador ascendente (SRAA, estado de alerta) e/ou do córtex (conteúdo). A primeira bifurcação diagnóstica é etiológica: causas **tóxico-metabólicas** (afetam o cérebro de forma difusa e simétrica) x causas **estruturais** (lesão focal com efeito de massa ou compressão de tronco). Essa dicotomia orienta toda a investigação e a urgência da conduta.

## Pivô clínico

Sinais de localização + padrão pupilar decidem entre tóxico-metabólico e estrutural. Dentro do estrutural, o padrão de instalação (rápido x lento) e a presença/ausência de anisocoria precoce decidem entre herniação uncal e central — os dois padrões de herniação são o par mais confundível do tema.

## Palavras-âncora

SRAA; pupilas isocóricas fotorreagentes = tóxico-metabólico; anisocoria precoce = uncal; Cheyne-Stokes; reflexo córneo-palpebral; teste de apneia; morte encefálica.
...
|---|---|---|---|
| Definição de coma | Incapacidade de obedecer a comandos, falar ou abrir os olhos, mesmo com estímulo doloroso | Neuro_COMA p.1; APOSTILA p.84 | CONFIRMADO (2 fontes) |
| Etiologia tóxico-metabólica | Ausência de sinais de localização, pupilas isocóricas e fotorreagentes, alterações laboratoriais, causa clínica sistêmica | 2 fontes | CONFIRMADO |
| Etiologia estrutural | Sinais de localização presentes, anisocoria, pupilas não-fotorreagentes, desvio conjugado do olhar, evidência de TCE | 2 fontes | CONFIRMADO |
| Localização por padrão pupilar | Mióticas = diencéfalo; médio-fixas = mesencéfalo; puntiformes = ponte; midríase bilateral fixa = bulbo (progressão rostro-caudal) | Neuro_COMA p.4-5; APOSTILA p.85 | CONFIRMADO (2 fontes) |
...
| Frente | Verso | Tipo |
|---|---|---|
| Achado que separa tóxico-metabólico de estrutural | Sinais de localização + padrão pupilar | conceito |
| Padrão pupilar tóxico-metabólico clássico | Isocóricas e fotorreagentes | dado |
