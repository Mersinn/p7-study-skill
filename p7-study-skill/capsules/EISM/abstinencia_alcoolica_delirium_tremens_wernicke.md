...
- Evidência de prova/devolutiva: sem evidência de cobrança específica no Source Pack lido (o cluster marca "cai: false" para este tema) — mesmo assim, risco clínico alto por orientação direta do cluster (tiamina antes de glicose é ponto explicitamente cobrado).
...
Síndrome de Abstinência Alcoólica (SAA) é o conjunto de sintomas físicos/psíquicos que surge após interrupção ou redução abrupta do consumo crônico de álcool — só existe abstinência se já havia dependência. Delirium Tremens é a forma mais grave da SAA (psicose orgânica reversível). Encefalopatia de Wernicke é emergência neurológica por déficit de tiamina, típica de etilista/desnutrido, que pode ser PRECIPITADA por reposição de glicose sem tiamina prévia.

## Pivô clínico

Na suspeita de dependência alcoólica/desnutrição, administrar tiamina SEMPRE antes (ou concomitante) à reposição de glicose — nunca depois — para não precipitar/agravar Wernicke.
...
|---|---|---|---|
| Início da SAA | poucas horas após interrupção/redução; 1 slide visual especifica "a partir de 6h" | 3 fontes NATIVA; Transtornos_por_abuso p.3 | CONFIRMADO |
...
| CIWA-Ar (10 itens) | Leve = 0–9; Moderada = 10–18; Grave = >18 | Psiquiatria_DEPENDE_NCIA p.6 | confirmar no slide (só 1 fonte traz o escore; sem camada A cobrindo este ponto) |
...
| Tiamina — dose profilática pré-glicose | 100mg via parenteral (2 de 3 fontes NATIVA concordam); 1 fonte (Psiquiatria_DEPENDE_NCIA) registra 300mg | Psiquiatria_DEPENDE_NCIA p.4 (300mg) x A_lcool_e_Outras_Drogas p.4 e transtornos_por_uso p.3 (100mg) | CORRIGIDO — usar 100mg (maioria das fontes; camada A não cobre este ponto específico) |
| Tiamina — tratamento da SAA/DT já estabelecidos | 100 a 250mg IM ou EV por 3–5 dias; se confusão mental/ataxia/nistagmo, aumentar até 500mg 3x/dia | 3 fontes NATIVA + visual p.4–5 | CONFIRMADO |
| Diazepam (SAA/DT) | padrão-ouro; 10–20mg VO a cada hora; se necessário, EV 10mg em 4 min sem diluição (retaguarda p/ parada respiratória) | 3 fontes NATIVA + visual p.4 | CONFIRMADO |
| Lorazepam (alternativa, hepatopatia) | 2–4mg VO a cada hora, máx. 12mg/dia | 3 fontes NATIVA + visual p.4 | CONFIRMADO |
...
- Nem todo paciente etilizado está hipoglicêmico — mas, se for repor glicose, a tiamina vem antes de qualquer forma.
...
- Inicial: reconhecer dependência e tempo desde a última dose; cuidados gerais (repouso, ambiente com estímulo reduzido, monitorização de glicemia/eletrólitos/hidratação); administrar tiamina antes de qualquer reposição de glicose.
- Definitiva: farmacoterapia com BZD (diazepam VO 10–20mg/h, padrão-ouro; lorazepam se hepatopatia) + tiamina 100–250mg IM/EV por 3–5 dias (até 500mg 3x/dia se sinais de Wernicke); tratar comorbidades (TCE, infecção, hepatopatia, hemorragia digestiva).
...
Variável decisiva: paciente etilista desnutrido chega em coma e a equipe repõe glicose antes de tiamina → conduta errada; a correta é tiamina primeiro (ou concomitante).

## Cards mínimos

| Frente | Verso | Tipo |
|---|---|---|
| Ordem tiamina x glicose | Tiamina antes (ou junto) da glicose, nunca depois | pegadinha |
...
- Critério de parada: acertar a ordem tiamina-glicose e a escolha certa (haloperidol vs BZD) conforme intoxicação vs abstinência em 3 vinhetas seguidas.
