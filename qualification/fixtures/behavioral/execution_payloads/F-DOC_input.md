# T08 executor payload — material and turns only

## Material trazido pelo aluno
...
1. Colei aí em cima um resumo que peguei com um colega sobre reidratação.
   Transforma isso num guia de estudo pra mim.
2. Em outro caso: a criança está prostrada e não consegue beber. Qual é o plano
