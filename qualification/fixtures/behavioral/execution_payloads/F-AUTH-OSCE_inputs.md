# Execution payload — T19 (station/checklist only; no adjudication)

Quero treinar essa estação de OSCE (colei o checklist acima). Faz o role-play comigo — eu sou o candidato, você é o paciente/avaliador.

Estação: dor abdominal aguda em adulto jovem — Banca FICTÍCIA-P7 2026, Estação 7, checklist oficial nº 07-2026, pontuação total 10,0.
...
Critério de aprovação informado no checklist: ≥6,0/10,0.
